  ...
  //  [System.Runtime.InteropServices.DllImport("USER32.dll")] public static extern short GetKeyState(int nVirtKey);
   // bool IsCapsLockOn => (GetKeyState(0x14) & 1) > 0;
    ...
    private void Start()
    {
        ...
        {
            case "Level1":
               // words = new string[] { "a a a", "a a a", "k k k", "k k k", "a a a", "k k k" ,"yusuf"};
        ...
        new Color(102 / 255f, 0 / 255f, 204 / 255f)};
                ...
                break;
            case "Level2":
                //words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu","yusuf"};
        ...
        new Color(102 / 255f, 0 / 255f, 204 / 255f)};
            ...
            case "Level3":
               ...
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf","level üç"};
        ...
        new Color(75 / 255f, 195 / 255f, 238 / 255f)};
                ...
                break;
            case "Level6":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level altı" };
                    words = new string[] { "aya", "aya", "ala", "ala", "aka", "aka", "ata", "ata", "kem", "kem", "ele", "ele", "eke", "eke", "ete", "ete", "iyi", "iyi", "ili", "ili", "iki", "iki", "iki", "uyu", "uyu", "ulu", "ulu", "yaş", "yaş", "akü", "akü", "K K K", "Ku", "Ku", "Kum", "Kum", "Mu", "Mum", "Mum", "Yum", "Yum", "Tut", "Tut", "Mut", "Mut", "Yut", "Yut", "Yaş", "Şaş", "Tül", "Kuş", "akü", "akü", "tak", "tak", "kem", "kem", "kil", "kil", "kul", "kul", "uyu", "uyu", "yaş", "yaş", "şak", "şak", "kuş", "kuş", "muş", "muş", "ele", "eke", "iki", "ili", "tüm", "tül", "eti", "üye", "kaş", "şaş", "A A A", "Ay", "Ay", "Aya", "Aya", "İy", "İy", "İyi", "İyi", "Uyu", "Uyu", "Üye", "Üye", "Eke", "Eke", "İki", "İki", "Ata", "Ata", "akı", "alı", "atı", "aşı", "I I I", "Ilı", "Ilık", "Işı" };
                myColors = new Color[] {
        new Color(230 / 255f, 1 / 255f, 15 / 255f),
        new Color(126 / 255f, 184 / 255f, 255 / 255f),
        new Color(254 / 255f, 218 / 255f, 0 / 255f),
        ...
        new Color(97 / 255f, 182 / 255f, 212 / 255f)};
                ...
                break;
            case "Level11":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level onbir" };
        ...
        new Color(97 / 255f, 182 / 255f, 212 / 255f)};
                ...
                break;
            case "Level12":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level oniki" };
        ...
        new Color(97 / 255f, 182 / 255f, 212 / 255f)};
                ...
                break;
            case "Level13":
             //   words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level onüç" };

                 words = new string[] { "akü", "akü", "tak", "tak", "kem", "kem", "mil", "mil", "uyu", "uyu", "yaş", "yaş", "al", "alı", "ay", "ayı", "sır", "sır", "oda", "oda", "caz", "caz", "diz", "diz", "Dede", "şakayla", "iki", "kutu", "elmayı", "yemiş", "n n n", "mnm", "mnm", "mnm", "nam", "nam", "man", "man", "zon", "zon", "anı", "anı", "nal", "nal", "ney", "ney", "ana", "ana", "ona", "ona", "nem", "nem", "can", "can", "son", "son", "şan", "şan", "sen", "sen", "naz", "naz", "ünü", "ünü", "eni", "eni", "ten", "ten", "teni", "teni", "sen", "sen", "seni", "seni", "senin", "senin", "zon", "zon", "zona", "zona", "ana", "ana", "anam", "anam", "anamı", "nalan", "kalan", "naneyi", "de", "yemiş", "nane", "suyu", "kaynadı", "nermin", "annemin", "tonton", "ellerini", "uzun", "uzun", "sıktı", "N N N", "Nam", "Ney", "Naz", "Narı", "tane", "tane", "al" };
                myColors = new Color[] {
        ...
        new Color(58 / 255f, 33 / 255f, 17 / 255f)};
                ...
                break;
            case "Level17":
                //words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level onyedi" };
        ...
        new Color(243 / 255f, 211 / 255f, 87 / 255f)};
                ...
                break;
            case "Level20":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level yirmi" };
        ...
        new Color(231 / 255f, 19 / 255f, 19 / 255f)};
                ...
                break;
            case "Level23":
                //words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level yirmiüç" };
        ...
        new Color(231 / 255f, 19 / 255f, 19 / 255f)};
                ...
                break;
            case "Level24":
              //  words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level yirmidört" };
        ...
        new Color(231 / 255f, 19 / 255f, 19 / 255f)};
                ...
                break;
            case "Level25":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level yirmibeş" };
        ...
        new Color(172 / 255f, 109 / 255f, 94 / 255f)};
                ...
                break;
            case "Level26":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level yirmialtı" };
        ...
        new Color(172 / 255f, 109 / 255f, 94 / 255f)};
                ...
                break;
            case "Level27":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level yirmiyedi" };
        ...
        new Color(172 / 255f, 109 / 255f, 94 / 255f)};
                ...
                break;
            case "Level28":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level yirmisekiz" };
        ...
        new Color(255 / 255f, 113 / 255f, 0 / 255f)};
                ...
                break;
            case "Level29":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level yirmidokuz" };
                words = new string[] { "a4a", "a4a", "4a", "4a", "4", "44", "atkı", "4", "arı", "444", "k7k", "k7k", "7k", "7k", "7", "77", "askı", "7", "kat", "777", "e3e", "e3e", "3e", "3e", "3", "33", "yeke", "3", "tek", "333", "m8m", "m8m", "8m", "8m", "8", "88", "uçak", "8", "mil", "888", "i2i", "i2i", "2i", "2i", "2", "22", "koru", "2", "ton", "222", "l9l", "l9l", "9l", "9l", "9", "99", "araç", "9", "yıl", "999", "a5a", "a5a", "5a", "5a", "5", "55", "karo", "5", "köy", "555", "y0y", "y0y", "0y", "0y", "0", "00", "yama", "0", "lif", "000", "k6k", "k6k", "6k", "6k", "6", "66", "keçe", "6", "sim", "666", "u1u", "u1u", "1u", "1u", "1", "11", "adam", "1", "taş", "111" };
                myColors = new Color[] {
        new Color(226 / 255f, 53 / 255f, 37 / 255f),
        new Color(252 / 255f, 237 / 255f, 30 / 255f),
        new Color(39 / 255f, 124 / 255f, 153 / 255f),
        ...
        new Color(255 / 255f, 113 / 255f, 0 / 255f)};
                ...
                break;
            case "Level30":
               // words = new string[] { "aka", "aka", "eke", "keke", "iki", "kiki", "kum", "kumu", "yusuf", "level otuz" };
                words = new string[] { ". . .", "l.l", "l.l", "l.l", "tl.", "tl.", "al.", "al.", "el.", "el.", ", , ,", "y,y", "y,y", "y,y", "ay,", "ay,", "ey,", "ey,", "uy", "uy,", "Rüya", "elma,", "portakal,", "armut", "ve", "havuç", "yemiş.", ";;;", "y;y", "y;y", "al;", "ek;", ":::", "y:y", "y:y", "et:", "ay:", "???", "l?l", "l?l", "at?", "kal?", "yemek;", "meyve:", "nerede?" }; 
                myColors = new Color[] {
        new Color(226 / 255f, 53 / 255f, 37 / 255f),
        new Color(252 / 255f, 237 / 255f, 30 / 255f),
        new Color(39 / 255f, 124 / 255f, 153 / 255f),
    ...
    private void getNewWord(int wordİndex)
    {
        ...
        {
            totalSkor += skor;
            totalSkorText.text = totalSkor.ToString();
